...
class PostController extends BaseController
{
    public function index(Request $request) {
        $recentPosts = $this->api('post.recent')->parameters(['where' => ['post_id' => 0], 'with' => ['thread', 'thread.category', 'thread.readers', 'thread.posts']])->get();

        $categories = $this->api('category.index')->parameters(['where' => ['category_id' => 0]])->get();

        event(new UserViewingIndex);

        return view('forum::post.index', compact('categories', 'recentPosts'));
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('forum::post.show', compact('categories', 'category', 'thread', 'post'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('forum::post.create', compact('categories', 'thread', 'post'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('forum::post.edit', compact('categories', 'category', 'thread', 'post'));
    }
